...
<body>
    <main class="container my-5">
            ...
            <div class="col-lg-6">
                <div class="card shadow-sm h-100">
                    <div class="card-header bg-dark text-white text-center">
                        <h1 class="h4 mb-0">Funciones anónimas</h1>
                    </div>
                    <div class="card-body">
        ...
        <div class="mt-4 d-flex justify-content-between">
            <a href="../Ejercicio13/GonzalezIsmael313.php" class="btn btn-secondary">&laquo; Ejercicio Anterior</a>
            <a href="../index.htm" class="btn btn-primary">Volver al Index</a>
            <a href="../Ejercicio15/GonzalezIsmael315.php" class="btn btn-secondary">Siguiente Ejercicio &raquo;</a>
        </div>
    </main>
