...
<body class="bg-light">
    ...
    <main class="container my-5">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-8 col-lg-6">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-header bg-dark text-white"><h1 class="h4 mb-0 text-center">Llamada a funciones desde libreria</h1></div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="get" onsubmit="return validarForm()">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" name="operacion[]" id="division" value="division" <?php echo (isset($_GET['operacion']) && in_array('division', $_GET['operacion'])) ? 'checked' : ''; ?>>
                                <label class="form-check-label" for="cociente">Calcular Division</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="operacion[]" id="mcd" value="mcd" <?php echo (isset($_GET['operacion']) && in_array('mcd', $_GET['operacion'])) ? 'checked' : ''; ?>>
                                <label class="form-check-label" for="resto">Calcular MCD</label>
                            </div>
                    ...
                    <!-- Bloque PHP para procesar el formulario y mostrar el resultado -->
                     <?php
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "GET" && !empty($_GET['dividendo']) && !empty($_GET['divisor']) && !empty($_GET['operacion'])) {
                            ...
                            */
                            ...
                            // Mostramos el resultado de la division si se seleccionó
                            if (in_array('division', $operaciones)) {
                                echo "<h5>Resultados para: $dividendo / $divisor</h5>";
                                echo '<h4>Cociente: <span class="badge bg-success fs-4">' , divisionEuclides($dividendo, $divisor)[0] , '</span></h4>';
                                echo '<h4>Resto: <span class="badge bg-warning fs-4">' , divisionEuclides($dividendo, $divisor)[1] , '</span></h4>';
                            }

                            // Mostramos el mcd si se seleccionó
                            if (in_array('mcd', $operaciones)) {
                                echo "<h5>Resultados para MCD de $dividendo y $divisor</h5>";
                                echo '<h4>MCD: <span class="badge bg-success fs-4">' , mcdEuclides($dividendo, $divisor) , '</span></h4>';
                            }
                            echo '</div>';
                        }
                    ?>
        ...
        <div class="mt-4 d-flex justify-content-between">
            <a href="../Ejercicio3/GonzalezIsmael33.php" class="btn btn-secondary">&laquo; Ejercicio Anterior</a>
            <a href="../index.htm" class="btn btn-primary">Volver al Index</a>
            <a href="../Ejercicio5/GonzalezIsmael35.php" class="btn btn-secondary">Siguiente Ejercicio &raquo;</a>
        </div>
    </main>
