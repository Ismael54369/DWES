...
<body class="bg-light">
    ...
    <main class="container my-5">
                ...
                <div class="card shadow-sm">
                    ...
                    <!-- PHP para calcular el factorial si se ha enviado el formulario -->
                     ...
                     if ($_SERVER["REQUEST_METHOD"] == "GET" && !empty($_GET['num'])) {
                        ...
                        echo '<h4>Factorial de ' , $num , ': <span class="badge bg-primary fs-4">' , factorial($num) , '</span></h4>';
                        echo '</div>';
                    }
                    ?>
                </div> 
        ...
        <div class="mt-4 d-flex justify-content-between">
            <a href="../Ejercicio1/GonzalezIsmael31.php" class="btn btn-secondary">&laquo; Ejercicio Anterior</a>
            <a href="../index.htm" class="btn btn-primary">Volver al Index</a>
            <a href="../Ejercicio3/GonzalezIsmael33.php" class="btn btn-secondary">Siguiente Ejercicio &raquo;</a>
        </div>
    </main>
