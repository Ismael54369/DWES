...
<body class="bg-light">
    <main class="container my-5">
                ...
                <div class="card shadow-sm">
                    ...
                    <?php
                        ...
                        if(isset($_POST['submit'])) {
                            ...
                            echo '<h5>La cadena invertida seria:</h5>';
                            echo '<p class="mb-1"><strong><span class="text-success">' , implode(' ', array_reverse($palabras)) , '</span></strong></p>';
                            echo '</div>';
                        }
                    ?>
                </div>
        ...
        <div class="mt-4 d-flex justify-content-between">
            <a href="../Ejercicio9/GonzalezIsmael39.php" class="btn btn-secondary">&laquo; Ejercicio Anterior</a>
            <a href="../index.htm" class="btn btn-primary">Volver al Index</a>
            <a href="../Ejercicio11/GonzalezIsmael311.php" class="btn btn-secondary">Siguiente Ejercicio &raquo;</a>
        </div>
    </main>
