...
<body class="bg-light">
    ...
    <main class="container my-5">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-8 col-lg-6">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-header bg-dark text-white"><h1 class="h4 mb-0 text-center">Division y MCD</h1></div>
        ...
        <div class="mt-4 d-flex justify-content-between">
            <a href="../Ejercicio2/GonzalezIsmael32.php" class="btn btn-secondary">&laquo; Ejercicio Anterior</a>
            <a href="../index.htm" class="btn btn-primary">Volver al Index</a>
            <a href="../Ejercicio4/GonzalezIsmael34.php" class="btn btn-secondary">Siguiente Ejercicio &raquo;</a>
        </div>
    </main>
