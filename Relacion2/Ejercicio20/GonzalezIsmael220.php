...
<body class="bg-light">
    ...
    <main class="container my-5">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="get" onsubmit="return validarForm()">
                            ...
                            <div class="mb-3">
                                ...
                                <!-- Modificado: Se añade una opción por defecto deshabilitada y el atributo 'required' -->
                                <select name="base" id="base" class="form-select mt-3" required>
        ...
        <div class="mt-4 d-flex justify-content-between">
            <a href="../Ejercicio19/GonzalezIsmael219.php" class="btn btn-secondary">&laquo; Ejercicio Anterior</a>
            <a href="../index.html" class="btn btn-primary">Volver al Index</a>
            <a href="../../super-index.html" class="btn btn-secondary">Siguiente Ejercicio &raquo;</a>
        </div>
    </main>
