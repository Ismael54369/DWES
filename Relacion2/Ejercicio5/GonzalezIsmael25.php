...
<body class="bg-light">
    <div class="container mt-5">
        ...
        <div class="mt-4 d-flex justify-content-between">
            <a href="../Ejercicio4/GonzalezIsmael24.php" class="btn btn-secondary">&laquo; Ejercicio Anterior</a>
            <a href="../index.html" class="btn btn-primary">Volver al Index</a>
            <a href="../GonzalezIsmael26.php" class="btn btn-secondary">Siguiente Ejercicio &raquo;</a>
        </div>
    </div>
</body>
</html>